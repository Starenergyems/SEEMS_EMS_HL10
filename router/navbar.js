...
async function getData() {
  ...
  if (flag === 0 || now.isSame(startOfDay, "day")) {
    const night = moment()
      .set({ hour: 0, minute: 0, second: 0, millisecond: 0 }) // 設置結束時間為 23:59:59.999
      .utcOffset("+0800")
      .format("YYYY-MM-DDTHH:mm:ss.000[Z]");
    const nightoneseconds = moment()
      .set({ hour: 0, minute: 0, second: 1, millisecond: 0 }) // 設置結束時間為 23:59:59.999
      .utcOffset("+0800")
      .format("YYYY-MM-DDTHH:mm:ss.000[Z]");
...
module.exports = {
  ...
  getLatestValuesFromDatabaseforother,
  getData,
};
