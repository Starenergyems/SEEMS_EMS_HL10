...
const setBut_LC1_BMS = document.querySelector(".infoLC_1 #setBut_onGridStatus_LC1");
...
const setBut_LC2_BMS = document.querySelector(".infoLC_2 #setBut_onGridStatus_LC2");
...
const setBut_LC3_BMS = document.querySelector(".infoLC_3 #setBut_onGridStatus_LC3");
...
const setBut_LC4_BMS = document.querySelector(".infoLC_4 #setBut_onGridStatus_LC4");
