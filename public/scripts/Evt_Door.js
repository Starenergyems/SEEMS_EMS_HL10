...
async function updateTable(){
    ...
    dataset = await getData('http://localhost:3005/event/door/edit');//port要改
    console.log(dataset);
    $('#evtTable').DataTable({
...
function QueryLog() {
    if (dateStart.value === "") {
        ...
        dataPost('http://localhost:3005/event/door/edit', dateStart.value, timeStart.value, dateEnd.value, timeEnd.value)//送給後端
