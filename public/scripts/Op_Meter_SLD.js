...
const closeWB_info_Recloser = document.querySelector(
  ".info_Recloser #closeWB_No"
);
...
const closeWB_info_RelayMVCB = document.querySelector(
  ".info_RelayMVCB #closeWB_No"
);
...
const closeWB_info_RelayVCB = document.querySelector(
  ".info_RelayVCB #closeWB_No"
);
